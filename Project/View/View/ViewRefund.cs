...
{
    public partial class ViewRefund : UserControlCustom
    {
        #region Attribute
        ...
        public ViewRefund(Interface_fnc intFnc)
        {
            _intFnc = intFnc;
            InitializeComponent();
        }
        ...
        private void RefundGift(int rowIndex)
        {
            ...
            Refund.GetRefund(_intFnc.CurrentProject.Refunds, _dataGridViewRefund.Rows[rowIndex].Cells[ColumnRfdId.Index].Value.ToString()).CurrentStatus = Refund.Status.GIFT;
        }
        private void RefundCompleteExchange(int rowIndex)
        {
            ...
            Refund.GetRefund(_intFnc.CurrentProject.Refunds, _dataGridViewRefund.Rows[rowIndex].Cells[ColumnRfdId.Index].Value.ToString()).CurrentStatus = Refund.Status.REFUNDED;
        }
        private void RefundCancel(int rowIndex)
        {
            ...
            Refund.GetRefund(_intFnc.CurrentProject.Refunds, _dataGridViewRefund.Rows[rowIndex].Cells[ColumnRfdId.Index].Value.ToString()).CurrentStatus = Refund.Status.CANCELED;
        }
